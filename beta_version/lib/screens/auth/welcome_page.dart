...
class WelcomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String imagePath = MediaQuery.of(context).size.shortestSide > 600
        ? 'assets/images/girl_background_tablet.png'
        ...
        child: Column(
            ...
            children: [
              ...
              Text(' your oral motor muscles',
                  style:
                      AppTypographyData.greyShades_5().sourceSansProBodyBold),
